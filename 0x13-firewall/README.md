...
<img src="./firewall_project.png" alt="firewall_project" width=90%>

## Background Context

- **Your Servers without a firewall...**

<img src="./server_without_firewall.gif" alt="server_without_firewall" width=65%>
...
PRO-TIP😎: the file to be edited from your server is `/etc/ufw/before.rules`
