...
- Requirement:
	...
	```sh
	kazzywiz@Kazzywiz:~/alx-system_engineering-devops/0x04-loops_conditions_and_parsing$ ./102-lets_parse_apache_logs | tail -n 10
	185.130.5.207 301
	185.130.5.207 301
	91.224.140.223 200
	62.210.142.23 304
...
- Requirements:
	...
	- You are not allowed to use `while`, `for`, `until` and `cut`
	```sh
	kazzywiz@Kazzywiz:~/alx-system_engineering-devops/0x04-loops_conditions_and_parsing$ ./103-dig_the-data | head -n 10
